...
@OslcName("Port")
@OslcResourceShape(title = "Port Resource Shape", describes = Constants.TYPE_SYSML_PORT)
public class SysMLPort extends AbstractResource{

	public SysMLPort() throws URISyntaxException {
		super();
	}
	public SysMLPort(URI about) throws URISyntaxException {
		super(about);
	}
