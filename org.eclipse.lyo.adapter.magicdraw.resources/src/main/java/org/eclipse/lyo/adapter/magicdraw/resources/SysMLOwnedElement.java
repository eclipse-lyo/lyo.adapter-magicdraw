...
@OslcResourceShape(title = "OwnedElement Resource Shape", describes = Constants.TYPE_SYSML_OWNEDELEMENT)
public class SysMLOwnedElement extends AbstractResource{

	public SysMLOwnedElement() throws URISyntaxException {
		super();
	}
	public SysMLOwnedElement(URI about) throws URISyntaxException {
		super(about);
	}
