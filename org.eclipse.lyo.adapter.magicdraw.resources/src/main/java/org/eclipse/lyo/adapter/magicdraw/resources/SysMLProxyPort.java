...
@OslcName("ProxyPort")
@OslcResourceShape(title = "ProxyPort Resource Shape", describes = Constants.TYPE_SYSML_PROXYPORT)
public class SysMLProxyPort extends AbstractResource{

	public SysMLProxyPort() throws URISyntaxException {
		super();
	}
	public SysMLProxyPort(URI about) throws URISyntaxException {
		super(about);
	}
