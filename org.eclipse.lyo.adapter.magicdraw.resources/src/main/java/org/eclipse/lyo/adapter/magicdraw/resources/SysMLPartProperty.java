...
@OslcResourceShape(title = "PartProperty Resource Shape", describes = Constants.TYPE_SYSML_PARTPROPERTY)
public class SysMLPartProperty extends AbstractResource{

	public SysMLPartProperty() throws URISyntaxException {
		super();
	}
	public SysMLPartProperty(URI about) throws URISyntaxException {
		super(about);
	}
