...
@OslcResourceShape(title = "FlowProperty Resource Shape", describes = Constants.TYPE_SYSML_FLOWPROPERTY)
public class SysMLFlowProperty extends AbstractResource{

	public SysMLFlowProperty() throws URISyntaxException {
		super();
	}
	public SysMLFlowProperty(URI about) throws URISyntaxException {
		super(about);
	}
	...
	@OslcDescription("Description of FlowProperty::direction TBD")
	@OslcName("direction")
	@OslcOccurs(Occurs.ZeroOrOne)
	@OslcPropertyDefinition("http://omg.org/sysml/rdf#FlowProperty/direction")
	@OslcTitle("direction")
	@OslcValueType(ValueType.XMLLiteral)
