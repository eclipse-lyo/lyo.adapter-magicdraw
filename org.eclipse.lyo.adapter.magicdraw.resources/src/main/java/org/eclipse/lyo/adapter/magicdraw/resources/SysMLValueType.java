...
public class SysMLValueType extends AbstractResource{
	...
	@OslcName("unit")
	@OslcPropertyDefinition("http://omg.org/sysml/rdf#ValueType/unit")
	@OslcTitle("unit")
	@OslcRange("http://omg.org/sysml/rdf#Unit")
	public URI  getUnit() {
		 return unit;
	}
	...
	@OslcPropertyDefinition("http://omg.org/sysml/rdf#ValueType/quantityKind")
