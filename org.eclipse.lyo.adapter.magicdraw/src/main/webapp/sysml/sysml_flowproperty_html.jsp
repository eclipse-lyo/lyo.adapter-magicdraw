...
SysMLFlowProperty element = (SysMLFlowProperty)request.getAttribute("flowProperty");
...
<title>MagicDraw OSLC Adapter: MagicDraw Flow Property</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Flow Property</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">MagicDraw Flow Property </span><%= element.getName() %></h1>
		<br>
		...
		<% if(element.getDirection() != null) { %>
			<p><span id="metainfo">Direction: </span><%= element.getDirection() %></p>
		<% } %>
