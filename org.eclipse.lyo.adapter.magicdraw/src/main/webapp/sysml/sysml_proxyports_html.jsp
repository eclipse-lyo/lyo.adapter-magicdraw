...
<title>MagicDraw OSLC Adapter: MagicDraw Proxy Ports</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Proxy Ports</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">MagicDraw Proxy Ports </span><%= modelName %></h1>
		<br>
