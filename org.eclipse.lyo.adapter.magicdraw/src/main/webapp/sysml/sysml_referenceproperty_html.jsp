...
SysMLReferenceProperty element = (SysMLReferenceProperty)request.getAttribute("referenceProperty");
...
<title>MagicDraw OSLC Adapter: MagicDraw Reference Property</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Reference Property</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">MagicDraw Reference Property </span><%= element.getName() %></h1>
		<br>
