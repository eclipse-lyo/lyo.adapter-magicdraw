...
<title>MagicDraw OSLC Adapter: MagicDraw Requirements</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Requirements</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">MagicDraw Requirements </span><%= modelName %></h1>
		<br>
