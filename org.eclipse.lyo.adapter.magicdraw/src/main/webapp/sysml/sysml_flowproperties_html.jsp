...
<title>MagicDraw OSLC Adapter: MagicDraw Flow Properties</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Flow Properties</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">MagicDraw Flow Properties </span><%= modelName %></h1>
		<br>
