...
SysMLInterfaceBlock element = (SysMLInterfaceBlock)request.getAttribute("interfaceblock");
...
<title>MagicDraw OSLC Adapter: MagicDraw Interface Block</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Interface Block</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">MagicDraw Interface Block </span><%= element.getName() %></h1>
		<br>
