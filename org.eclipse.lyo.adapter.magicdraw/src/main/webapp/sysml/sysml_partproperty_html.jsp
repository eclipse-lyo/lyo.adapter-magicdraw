...
<title>MagicDraw OSLC Adapter: MagicDraw Part Property</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Part Property</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">MagicDraw Part Property </span><%= element.getName() %></h1>
		<br>
