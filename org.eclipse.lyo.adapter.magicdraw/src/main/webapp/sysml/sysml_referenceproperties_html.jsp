...
<title>MagicDraw OSLC Adapter: MagicDraw Reference Properties</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Reference Properties</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">MagicDraw Reference Properties </span><%= modelName %></h1>
		<br>
