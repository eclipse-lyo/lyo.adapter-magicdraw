...
<title>MagicDraw OSLC Adapter: MagicDraw Ports</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Ports</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">MagicDraw Ports </span><%= modelName %></h1>
		<br>
