...
SysMLInternalBlockDiagram element = (SysMLInternalBlockDiagram)request.getAttribute("internalblockdiagram");
...
<title>MagicDraw OSLC Adapter: MagicDraw Internal Block Diagram</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Internal Block Diagram</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">MagicDraw Internal Block Diagram </span><%= element.getName() %></h1>
		<br>
