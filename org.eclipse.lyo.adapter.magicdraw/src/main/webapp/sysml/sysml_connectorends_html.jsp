...
<title>MagicDraw OSLC Adapter: MagicDraw Connector Ends</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Connector Ends</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">MagicDraw Connector Ends </span><%= modelName %></h1>
		<br>
