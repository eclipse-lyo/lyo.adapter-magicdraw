...
<title>MagicDraw OSLC Adapter: MagicDraw Block Diagram</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Block Diagram</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">MagicDraw Block Diagram </span><%= element.getName() %></h1>
		<br>
