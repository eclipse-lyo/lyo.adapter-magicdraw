...
<title>MagicDraw OSLC Adapter: MagicDraw Blocks</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Blocks</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">MagicDraw Blocks </span><%= modelName %></h1>
		<br>
