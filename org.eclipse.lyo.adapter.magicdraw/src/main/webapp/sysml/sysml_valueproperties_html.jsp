...
<title>MagicDraw OSLC Adapter: MagicDraw Value Properties</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Value Properties</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">MagicDraw Value Properties </span><%= modelName %></h1>
		<br>
