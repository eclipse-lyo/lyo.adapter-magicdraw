...
<title>MagicDraw OSLC Adapter: MagicDraw Part Properties</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Part Properties</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">MagicDraw Part Properties </span><%= modelName %></h1>
		<br>
