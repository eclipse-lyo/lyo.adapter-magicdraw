...
<title>MagicDraw OSLC Adapter: MagicDraw Full Ports</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Full Ports</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">MagicDraw Full Ports </span><%= modelName %></h1>
		<br>
