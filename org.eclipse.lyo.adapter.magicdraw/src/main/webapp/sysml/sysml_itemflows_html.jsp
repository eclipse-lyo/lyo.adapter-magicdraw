...
<title>MagicDraw OSLC Adapter: MagicDraw Item Flows</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Item Flows</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">MagicDraw Item Flows </span><%= modelName %></h1>
		<br>
		...
		<% int i =  0;  %>
		<% if( elementsSize > 0) {  %>
		<p><span id="metainfo">Item Flows</span></p>
		<table>
			<tr>
