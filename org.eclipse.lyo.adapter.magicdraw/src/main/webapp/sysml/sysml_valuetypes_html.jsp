...
<title>MagicDraw OSLC Adapter: MagicDraw Value Types</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Value Types</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">MagicDraw Value Types </span><%= modelName %></h1>
		<br>
		...
		<% int i =  0;  %>
		<% if( elementsSize > 0) {  %>
		<p><span id="metainfo">Value Types</span></p>
		<table>
			<tr>
