...
<title>MagicDraw OSLC Adapter: MagicDraw Packages</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Packages</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">MagicDraw Packages </span><%= modelName %></h1>
		<br>
