...
SysMLPackage element = (SysMLPackage)request.getAttribute("package");
...
<title>MagicDraw OSLC Adapter: MagicDraw Package</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Package</p>
