...
SysMLValueProperty element = (SysMLValueProperty)request.getAttribute("valueProperty");
...
<title>MagicDraw OSLC Adapter: MagicDraw Value Property</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Value Property</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">MagicDraw Value Property </span><%= element.getName() %></h1>
		<br>
		...
		<% if(element.getDefaultValue() != null) { %>
			<p><span id="metainfo">Default Value: </span><%= element.getDefaultValue() %></p>
		<% } %>
