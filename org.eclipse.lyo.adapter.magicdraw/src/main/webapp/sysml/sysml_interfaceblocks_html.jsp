...
<title>MagicDraw OSLC Adapter: MagicDraw Interface Blocks</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Interface Blocks</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">MagicDraw Interface Blocks </span><%= modelName %></h1>
		<br>
		...
		<% int i =  0;  %>
		<% if( elementsSize > 0) {  %>
		<p><span id="metainfo">Interface Blocks</span></p>
		<table>
			<tr>
