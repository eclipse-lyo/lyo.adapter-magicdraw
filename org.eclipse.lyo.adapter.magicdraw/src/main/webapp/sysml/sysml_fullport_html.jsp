...
<title>MagicDraw OSLC Adapter: MagicDraw Full Port</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Full Port</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">MagicDraw Full Port </span><%= element.getName() %></h1>
		<br>
