...
<title>MagicDraw OSLC Adapter: MagicDraw Block Diagrams</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Block Diagrams</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">MagicDraw Block Diagrams </span><%= modelName %></h1>
		<br>
		...
		<% int i =  0;  %>
		<% if( elementsSize > 0) {  %>
		<p><span id="metainfo">Block Diagrams</span></p>
		<table>
			<tr>
