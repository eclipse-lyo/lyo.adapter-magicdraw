...
<title>MagicDraw OSLC Adapter: MagicDraw Connectors</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Connectors</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">MagicDraw Connectors </span><%= modelName %></h1>
		<br>
