...
SysMLPort element = (SysMLPort)request.getAttribute("port");
...
<title>MagicDraw OSLC Adapter: MagicDraw Port</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: MagicDraw Port</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">MagicDraw Port </span><%= element.getName() %></h1>
		<br>
