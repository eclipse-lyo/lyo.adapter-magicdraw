...
public class SysMLRequirementService extends HttpServlet {
	...
	public SysMLRequirement getRequirement(@PathParam("projectId") final String projectId, 
		...
		MagicDrawManager.loadSysMLProject(projectId);
		SysMLRequirement sysMLRequirement = MagicDrawManager.getRequirementByID(requirementId);
	...
	public void getHtmlRequirement(
		...
		MagicDrawManager.loadSysMLProject(projectId);
		org.eclipse.lyo.adapter.magicdraw.resources.SysMLRequirement sysmlRequirement = MagicDrawManager.getRequirementByID(reqID);
