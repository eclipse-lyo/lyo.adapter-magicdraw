...
import org.eclipse.lyo.adapter.magicdraw.serviceproviders.ServiceProviderCatalogSingleton;
...
/**
 * ServiceProviderCatalogService is a servlet containing the implementation
 * of OSLC RESTful web services returning ServiceProviderCatalog resources
...
public class ServiceProviderCatalogService
{
    ...
    public void getHtmlServiceProvider(@PathParam("serviceProviderId") final String serviceProviderId)
    {
    	...
    	{	        
	        ...
	        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/sysml/serviceprovidercatalog_html.jsp");
    		try {
