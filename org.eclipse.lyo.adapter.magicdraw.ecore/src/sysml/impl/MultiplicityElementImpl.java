 ...
 * <ul>
 *   <li>{@link sysml.impl.MultiplicityElementImpl#getLower <em>Lower</em>}</li>
 *   <li>{@link sysml.impl.MultiplicityElementImpl#getUpper <em>Upper</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class MultiplicityElementImpl extends MinimalEObjectImpl.Container implements MultiplicityElement {
	...
	protected EClass eStaticClass() {
		return SysmlPackage.Literals.MULTIPLICITY_ELEMENT;
	}
	...
	public void setLower(String newLower) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SysmlPackage.MULTIPLICITY_ELEMENT__LOWER, oldLower, lower));
	}
	...
	public void setUpper(String newUpper) {
		...
		upper = newUpper;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SysmlPackage.MULTIPLICITY_ELEMENT__UPPER, oldUpper, upper));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SysmlPackage.MULTIPLICITY_ELEMENT__LOWER:
				return getLower();
			case SysmlPackage.MULTIPLICITY_ELEMENT__UPPER:
				return getUpper();
		}
