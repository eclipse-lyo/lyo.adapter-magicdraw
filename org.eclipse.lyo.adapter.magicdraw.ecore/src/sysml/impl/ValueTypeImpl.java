 ...
 * <ul>
 *   <li>{@link sysml.impl.ValueTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link sysml.impl.ValueTypeImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link sysml.impl.ValueTypeImpl#getQuantityKind <em>Quantity Kind</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ValueTypeImpl extends TypeImpl implements ValueType {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SysmlPackage.VALUE_TYPE__NAME, oldName, name));
	}
	...
	public QuantityKind getQuantityKind() {
		if (quantityKind != null && quantityKind.eIsProxy()) {
			...
			if (quantityKind != oldQuantityKind) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SysmlPackage.VALUE_TYPE__QUANTITY_KIND, oldQuantityKind, quantityKind));
			}
		}
		return quantityKind;
	}
	...
	public void setQuantityKind(QuantityKind newQuantityKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SysmlPackage.VALUE_TYPE__QUANTITY_KIND, oldQuantityKind, quantityKind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SysmlPackage.VALUE_TYPE__NAME:
				return getName();
			case SysmlPackage.VALUE_TYPE__UNIT:
				if (resolve) return getUnit();
				return basicGetUnit();
			case SysmlPackage.VALUE_TYPE__QUANTITY_KIND:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (derivedFeatureID) {
				case SysmlPackage.VALUE_TYPE__NAME: return SysmlPackage.NAMED_ELEMENT__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseFeatureID) {
				case SysmlPackage.NAMED_ELEMENT__NAME: return SysmlPackage.VALUE_TYPE__NAME;
				default: return -1;
			}
		}
