 ...
 * <ul>
 *   <li>{@link sysml.impl.ConnectorImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link sysml.impl.ConnectorImpl#getEnd <em>End</em>}</li>
 *   <li>{@link sysml.impl.ConnectorImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConnectorImpl extends NamedElementImpl implements Connector {
		...
		if (owner != null && owner.eIsProxy()) {
			...
			if (owner != oldOwner) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SysmlPackage.CONNECTOR__OWNER, oldOwner, owner));
			}
		}
		return owner;
	}
	...
	public void setOwner(NamedElement newOwner) {
		...
		owner = newOwner;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SysmlPackage.CONNECTOR__OWNER, oldOwner, owner));
	}
	...
	public EList<ConnectorEnd> getEnd() {
		if (end == null) {
			end = new EObjectResolvingEList<ConnectorEnd>(ConnectorEnd.class, this, SysmlPackage.CONNECTOR__END);
		}
		return end;
	}
	...
	public Association getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SysmlPackage.CONNECTOR__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(Association newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SysmlPackage.CONNECTOR__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SysmlPackage.CONNECTOR__OWNER:
				if (resolve) return getOwner();
				return basicGetOwner();
			case SysmlPackage.CONNECTOR__END:
				return getEnd();
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == OwnedElement.class) {
			switch (derivedFeatureID) {
				case SysmlPackage.CONNECTOR__OWNER: return SysmlPackage.OWNED_ELEMENT__OWNER;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == OwnedElement.class) {
			switch (baseFeatureID) {
				case SysmlPackage.OWNED_ELEMENT__OWNER: return SysmlPackage.CONNECTOR__OWNER;
				default: return -1;
			}
		}
